<template>
  ...
  >
    ...
    <template v-if="currentType" #title>
      <span>Max </span>
      <span
        v-if="
    ...
    >
      <!-- circle -->
      <div class="Counter">
        <v-progress-circular :rotate="270" :size="300" :width="5" :value="100">
          <div class="d-flex align-center justify-center flex-column">
            <v-avatar size="80" aspect-ratio="1" class="grey lighten-2 mb-3">
              <img :alt="currentType.name" :src="getImg(currentType.image)" />
            </v-avatar>
            ...
            >
              ...
              <span v-if="configurable">
                {{ $t('Best') }}: {{ bestStatsById(currentStats[index].id) }}x
              </span>
            </div>
          </div>
        </v-progress-circular>
