            ...
            <v-card flat>
              <v-card-text>
                ...
                <p>
                  ...
                  {{ appTitle }}. This policy is not applicable to any
                ...
                <p>
                  {{ appTitle }} follows a standard procedure of using log
                  ...
                  website or app, and gathering demographic information.
                </p>

                <h2>Cookies and Web Beacons</h2>

                <p>
                  Like any other website or app, {{ appTitle }} uses 'cookies'.
                ...
                <p>
                  ...
                  {{ appTitle }}, which are sent directly to users' browser.
                ...
                <p>
                  Note that {{ appTitle }} has no access to or control over
                ...
                <p>
                  {{ appTitle }}'s Privacy Policy does not apply to other
                ...
                <p>
                  {{ appTitle }} does not knowingly collect any Personal
                  ...
                  our website or app, we strongly encourage you to contact us
