        ...
        <v-row>
          <v-col cols="12">
            <v-card class="mb-8">
              <v-card-text>
                <p>
                  At HangTime, one of our main priorities is the privacy of our visitors. This
                  Privacy Policy document contains types of information that is collected and
                  recorded by HangTime and how we use it.
                </p>
                ...
                <p>
                  ...
                  visitors to our website or app with regards to the information that they shared
                  and/or collect in HangTime. This policy is not applicable to any information
                  collected offline or via channels other than this website or app.
                </p>
              </v-card-text>
            </v-card>
            <v-card class="mb-8">
              ...
              <v-card-text>
                <p>
                  By using our website or app, you hereby consent to our Privacy Policy and agree to
                  its terms.
                </p>
              </v-card-text>
            </v-card>
            <v-card class="mb-8">
              <v-card-title> Information we collect </v-card-title>
              <v-card-text>
                <p>
            ...
            <v-card class="mb-8">
              <v-card-title> How we use your information </v-card-title>
              <v-card-text>
                <p>We use the information we collect in various ways, including to:</p>

                <ul>
                  <li>Provide, operate, and maintain our website or app</li>
                  <li>Improve, personalize, and expand our website or app</li>
                  <li>Understand and analyze how you use our website or app</li>
                  ...
                  <li>
                    ...
                    to the website or app, and for marketing and promotional purposes
                  </li>
            ...
            <v-card class="mb-8">
              <v-card-title> Log Files </v-card-title>
              <v-card-text>
                <p>
                  HangTime follows a standard procedure of using log files. These files log visitors
                  ...
                  movement on the website or app, and gathering demographic information.
                </p>
              </v-card-text>
            </v-card>
            <v-card class="mb-8">
              <v-card-title> Cookies and Web Beacons </v-card-title>
              <v-card-text>
                <p>
                  Like any other website or app, HangTime uses 'cookies'. These cookies are used to
            ...
            <v-card class="mb-8">
              <v-card-title> Advertising Partners Privacy Policies </v-card-title>
              <v-card-text>
                <p>
                  ...
                  appear on HangTime, which are sent directly to users' browser. They automatically
                ...
                <p>
                  Note that HangTime has no access to or control over these cookies that are used by
                  third-party advertisers.
                </p>
              </v-card-text>
            </v-card>
            <v-card class="mb-8">
              <v-card-title> Third Party Privacy Policies </v-card-title>
              <v-card-text>
                <p>
                  HangTime's Privacy Policy does not apply to other advertisers or websites. Thus,
            ...
            <v-card class="mb-8">
              <v-card-title> GDPR Data Protection Rights </v-card-title>
              <v-card-text>
                <p>
            ...
            <v-card>
              <v-card-title> Children's Information </v-card-title>
              <v-card-text>
                <p>
                ...
                <p>
                  HangTime does not knowingly collect any Personal Identifiable Information from
                  children under the age of 13. If you think that your child provided this kind of
                  information on our website or app, we strongly encourage you to contact us
