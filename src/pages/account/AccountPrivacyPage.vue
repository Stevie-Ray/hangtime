        ...
        <v-row>
          <v-col cols="12">
            <v-card class="mb-8">
              <v-card-text>
                <p>
                  At HangTime, one of our main priorities is the privacy of our
                  visitors. This Privacy Policy document contains types of
                  information that is collected and recorded by HangTime and how
                  we use it.
                </p>
                ...
                <p>
                  ...
                  is valid for visitors to our website or app with regards to
                  the information that they shared and/or collect in HangTime.
                  This policy is not applicable to any information collected
                  offline or via channels other than this website or app.
                </p>
              </v-card-text>
            </v-card>
            <v-card class="mb-8">
              ...
              <v-card-text>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    or app, and for marketing and promotional purposes
                  </li>
            ...
            <v-card class="mb-8">
              ...
              <v-card-text>
                <p>
                  HangTime follows a standard procedure of using log files.
                  ...
                  site, tracking users' movement on the website or app, and
            ...
            <v-card class="mb-8">
              ...
              <v-card-text>
                <p>
                  Like any other website or app, HangTime uses 'cookies'. These
            ...
            <v-card class="mb-8">
              ...
              <v-card-text>
                <p>
                  ...
                  respective advertisements and links that appear on HangTime,
                ...
                <p>
                  Note that HangTime has no access to or control over these
            ...
            <v-card class="mb-8">
              ...
              <v-card-text>
                <p>
                  HangTime's Privacy Policy does not apply to other advertisers
            ...
            <v-card>
              ...
              <v-card-text>
                ...
                <p>
                  HangTime does not knowingly collect any Personal Identifiable
                  Information from children under the age of 13. If you think
                  that your child provided this kind of information on our
                  website or app, we strongly encourage you to contact us
